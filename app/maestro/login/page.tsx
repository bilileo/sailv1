  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white p-8 rounded-md shadow-lg w-full max-w-md border border-gray-200">
        ...
        <p className="text-center text-gray-500 text-sm mb-8">Acceso para alumnos</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-gray-300 rounded-sm px-3 py-2 text-black outline-none focus:ring-2 focus:ring-[#0b6e3f]"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#0b6e3f] text-white py-3 rounded-sm font-bold hover:bg-green-800 transition-colors disabled:opacity-50"
          >
